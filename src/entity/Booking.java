...
public class Booking {
    ...
    /** Records a recoverable cancellation audit trail instead of deleting the booking. */
    ...
    public int getActualNightsStayed() {
        if ("N/A".equals(actualCheckInDate) || "N/A".equals(actualCheckOutDate)) return 0;
